...
module Playbook.Models {
	...
	extends Common.Models.Modifiable {
		...
		public eligible: boolean; // position eligibility
		public index: number;
	...
	export class PositionDefault {
		...
		public getPosition(positionListValue: Playbook.Models.PositionList)
			: Playbook.Models.Position
		{
			let results = null;
		...
		public switchPosition(
			fromPosition: Playbook.Models.Position, 
			toPositionEnum: Playbook.Models.PositionList
		): Playbook.Models.Position {
		...
		:Playbook.Models.PositionCollection 
		{
