...
module Playbook.Models {
	...
	implements Playbook.Interfaces.IGrid {
		 ...
		 */
		public getCenter(): Playbook.Models.Coordinates {
		 ...
		 * @return {Playbook.Models.Coordinate} [description]
		 */
		public getCenterInPixels(): Playbook.Models.Coordinates {
		 ...
		 * @return {Playbook.Models.Coordinate} [description]
		 */
		public getCoordinates(): Playbook.Models.Coordinates {
		 ...
		 * @return {Playbook.Models.Coordinate} [description]
		 */
		public getDimensions(): Playbook.Models.Coordinates {
			return new Playbook.Models.Coordinates(
				this.cols, this.rows
			);
		}
		 ...
		 */
		public getAbsoluteFromCoordinates(x: number, y: number): Playbook.Models.Coordinates {
			let coords = new Playbook.Models.Coordinates(x, y);
			let calculatedCoords = new Playbook.Models.Coordinates(
				this.getAbsoluteFromCoordinate(coords.x),
		 ...
		 */
		public getCoordinatesFromAbsolute(x: number, y: number): Playbook.Models.Coordinates {
			let coords = new Playbook.Models.Coordinates(x, y);
		 ...
		 */
		public snapToNearest(ax: number, ay: number): Playbook.Models.Coordinates {
		 ...
		 */
		public snap(x: number, y: number): Playbook.Models.Coordinates {
			let coords = new Playbook.Models.Coordinates(x, y);
